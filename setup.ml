...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4e0cb2397607b3be7376b4bf3df527f0) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ocaml-usb-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ocaml-usb-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "http://ocaml-usb.forge.ocamlcore.org/";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "http://darcs.ocamlcore.org/cgi-bin/darcsweb.cgi?r=ocaml-usb;a=summary";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "usb";
                      lib_findlib_containers = [];
                      });
               Doc
                 ({
                     cs_name = "ocaml-usb-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      doc_title = "API reference for ocaml-usb";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
